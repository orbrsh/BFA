package booksForAll.create_tables;
...
/**
 * Application Life cycle Listener implementation class createTables
 *
 */
@WebListener
public class createTables implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event)  { 
    	...
    	try{
    		...
    		BasicDataSource ds = (BasicDataSource)context.lookup("java:comp/env/jdbc/booksForAllDatasource");
    		...
    		//	stmt.executeUpdate("CREATE TABLE MESSAGES( msgID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), Posted_by_userID INTEGER NOT NULL, Posted_by_Nickname varchar(255) NOT NULL, Date varchar(255) NOT NULL, Content varchar(255) NOT NULL, Republished_count INTEGER NOT NULL, PRIMARY KEY (msgID) )");
    			...
    			stmt.executeUpdate("CREATE TABLE USERS( userID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), UserName varchar(255) NOT NULL, Password varchar(255) NOT NULL, Nickname varchar(255) NOT NULL, Description varchar(32672), PhotoURL varchar(255), Following_count INTEGER, PRIMARY KEY (userID) )");
    ...
    public void contextDestroyed(ServletContextEvent event)  { 
        //shut down database
   	 try {
			DriverManager.getConnection("jdbc:derby:" + "exampleDB" +";shutdown=true");
		} catch (SQLException e) {
			ServletContext cntx = event.getServletContext();
