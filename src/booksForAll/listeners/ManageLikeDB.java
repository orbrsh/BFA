...
/**
 * An booksForAll listener that reads the like json file and populates the data into a Derby database
 */
@WebListener
public class ManageLikeDB implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event)  { 
    	...
    	try{
    		...
    		if (!created){
    			...
    			Collection<Like> likes = loadLikes(cntx.getResourceAsStream(File.separator +
    			...
    			for (Like like : likes){
    				...
    				pstmt.setLong(2,like.getIdBook());
    				pstmt.setBoolean(3,like.isActive());
    				pstmt.setTimestamp(4,like.getDataSet());
    				pstmt.executeUpdate();
    			}
